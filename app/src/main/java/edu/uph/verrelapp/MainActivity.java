...
import edu.uph.verrelapp.Adpater.ProdulAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static ProdulAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ProdulAdapter(produkArrayList, getApplicationContext());
    ...
    public void initRealm() {
        ...
        simpanDataProduk("Indomie Ayam Bawang 69g", 3100, R.drawable.indomie);
